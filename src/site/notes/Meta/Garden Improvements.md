...
- [ ] Post this site to Kagi Small Web (oh, ~~this requires the blog to be 3 years old~~. Maybe find a different aggregate to post to? Or join a web ring) (Well, I *thought* kagi requires the blog to be 3 years old, but I'm sensing that this was an old rule. Going to try to get this onto kagi asap.)
