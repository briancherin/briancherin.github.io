...
- [x] Post this site to Kagi Small Web (oh, ~~this requires the blog to be 3 years old~~. Maybe find a different aggregate to post to? Or join a web ring) (Well, I *thought* kagi requires the blog to be 3 years old, but I'm sensing that this was an old rule. Going to try to get this onto kagi asap.)
	- Has been [published](https://github.com/kagisearch/smallweb/pull/825) to Kagi!
...
- [ ] Idea: Text box input for readers on a page to answer a specific question or call for opinion. Responses would be private to me only. Promote discussion. (could be open to it being public too, not sure).
