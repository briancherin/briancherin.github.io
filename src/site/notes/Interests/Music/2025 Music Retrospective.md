...
At the beginning of a "cycle", I would use one of the music discovery methods (from auto-play, or recommendations) and then if an album caught my interest enough that it felt like it was worth listening to more, I created a new playlist and added the full album to the playlist. I then gave the playlist a name, pretty always a random phrase that popped into my head at that exact moment. I then AI-generated an image, based on the name I came up with and my current sentiment in that moment, and used it as the playlist cover image.
